function SKMORS2(Global)
    ...
    while iter > 0
        ...
        %% Plots at iteration=1 
        %{
        if (iteration == 1) && (Global.M == 2)
            plots(Global,Population, test_function, Mat_Obj);
            %plots(Global,Population, test_function, y);
            pause; fprintf('\n');
        end
        %}
